...
class ActionStrategy:
    ...
    def get_next_action (self, agent, lvps_x, lvps_y, scaler, last_action, last_action_result):
        action_params = {
            'agent':agent,
            'scaler':scaler,
        }
        ...
        if agent.is_out_of_bounds():
            ...
            lvps_target_x, lvps_target_y = agent.get_nearest_visible_target_position(lvps_x, lvps_y, scaler, agent.get_model())
